...
project = 'Miyako_2026'; % name of the project
lon0=143.046;          % hypocenter longitude
lat0=39.953;          % hypocenter latitude
dep=25.0;           % hypocenter depth
Mw=7.5;                % magnitude
sr=10;                % sampling rate in Hz
ori=120;              % length of seismograms before P-arrival
...
parr=125;            % P-wave arrival time
duration=35;        % earthquake duration
qs=80;              % number of grids in latitude
ps=100;              % number of grids in longitude
latrange=[-1.2 1.2];  % latitude length of the imaging domain
lonrange=[-1.5 1.5];% longitude length of the imaging domain
Band=1;             % frequency band for the back-projection
