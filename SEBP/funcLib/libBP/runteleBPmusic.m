function runteleBPmusic(path, BPfile, logFile)
...
musicbp_log(logFile, 'INFO', 'MUSIC output directory: %s', fullfile(inputDir, saveDir));
cd(saveDir);
...
save('parret', 'ret');
fclose(fileID);
musicbp_log(logFile, 'INFO', 'MUSIC back-projection finished: %s', fullfile(inputDir, saveDir));
