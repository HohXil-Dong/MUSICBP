...
%% PRE-SET
%%% INPUT
mother_loc = '/home/liuwei/HPSSD/Qinghai/BP/TeleDD_Loc/AU_workshop/';
ap_ca_loc  = '/home/liuwei/HPSSD/Qinghai/BP/TeleDD_Loc/AU_workshop/Calibrate/ca_ap_loc.mat';
ref = 25;
...
n_evt=3
    ...
    load(ap_ca_loc);	% Load ca and ap location of afteshocks
  	...
  	%% STEP 1: Get slowness error for the mainshock.
        ...
        lat_ca = lat_ca; lon_ca = lon_ca; dep_ca(1:n_evt,1) = ret.dep0; % AF catalog
 ...
 save Input/Par0.5_2_10_cali.mat
